...
async def start(bot, update):
        ...
        try:
            ...
            await update.reply_text(
                ...
                reply_markup=InlineKeyboardMarkup([
                    [ InlineKeyboardButton(text=" 💢 𝙹𝚘𝚒𝚗 𝙼𝚢 𝚄𝚙𝚍𝚊𝚝𝚎𝚜 𝙲𝚑𝚊𝚗𝚗𝚎𝚕 and try again💢 ", url=f"https://t.me/{UPDATE_CHANNEL}")]
              ])
            )
            return
        except Exception:
    ...
    if file_uid:
        ...
        caption = file_caption if file_caption != ("@MOVIEMARKET_DISCUSSION_GROUP" or None) else ("<code>" + file_name + "</code> @MOVIEMARKET_DISCUSSION_GROUP")
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton
                                (
                                    '👨‍💼 Owner 👨‍💼', url="https://t.me/Dashamoolamdamu_123"
                                )
                        ]
                    ]
                )
    ...
    buttons = [[
        ...
        InlineKeyboardButton('🖥️ Tutorial Video 🖥️', url='https://t.me/geronimo1234')
    ]]
...
async def about(bot, update):
    ...
    buttons = [[
        InlineKeyboardButton('Channel', url='https://t.me/MOVIE_MARKET_CHANNEL'),
